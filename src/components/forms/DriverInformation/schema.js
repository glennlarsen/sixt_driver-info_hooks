...
import { EMAIL_REGEX, MAX_PHONE_NUMBERS } from "constants/validationRules";
...
const schema = yup.object().shape({
  ...
  phone: yup.string().required("Please enter your Phone Number").max(MAX_PHONE_NUMBERS, "Phone number is to long"),
